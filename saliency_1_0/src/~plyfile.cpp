...
void convert_endian(char* array, int size) {	
...
)
{
  ...
  switch (type) {
    case PLY_CHAR:
      ret_val = fread (ptr, 1, 1, fp);
	  if(ret_val < 1) printf("File Read Error1\n");
      *int_val = (int)*((char *) ptr);
      *uint_val = (unsigned int)*int_val;
      *double_val = *int_val;
      break;
    case PLY_UCHAR:
      ret_val = fread(ptr, 1, 1, fp);
	  if(ret_val < 1) printf("File Read Error2\n");
      *uint_val = (unsigned int)*((unsigned char *) ptr);
      *int_val = (int)*uint_val;
      *double_val = *uint_val;
      break;
    case PLY_SHORT:
      ret_val = fread (ptr, 2, 1, fp);
	  if(ret_val < 1) printf("File Read Error3\n");
	  convert_endian((char* )ptr, 2);
      *int_val = (int)*((short int *) ptr);
      *uint_val = (unsigned int)*int_val;
      *double_val = *int_val;
      break;
    case PLY_USHORT:
      ret_val = fread (ptr, 2, 1, fp);
	  if(ret_val < 1) printf("File Read Error4\n");
	  convert_endian((char* )ptr, 2);
      *uint_val = (unsigned int)*((unsigned short int *) ptr);
      *int_val = (int)*uint_val;
      *double_val = *uint_val;
      break;
    case PLY_INT:
      ret_val = fread (ptr, 4, 1, fp);
	  if(ret_val < 1) printf("File Read Error5\n");
	  convert_endian((char* )ptr, 4);
      *int_val = *((int *) ptr);
      *uint_val = (unsigned int)*int_val;
      *double_val = *int_val;
      break;
    case PLY_UINT:
      ret_val = fread (ptr, 4, 1, fp);
	  if(ret_val < 1) printf("File Read Error6\n");
	  convert_endian((char* )ptr, 4);
      *uint_val = *((unsigned int *) ptr);
      *int_val = (int)*uint_val;
      *double_val = *uint_val;
    ...
    case PLY_FLOAT:
      ret_val = fread (ptr, 4, 1, fp);
	  if(feof(fp)) {
		printf("count = %d, End of file\n", count);
	  }
	  if(ret_val < 1) printf("count = %d, File Read Error7\n", count);
	  else count++;
	  convert_endian((char* )ptr, 4);
      *double_val = *((float *) ptr);
      *int_val = (int)*double_val;
      *uint_val = (unsigned int)*double_val;
      break;
    case PLY_DOUBLE:
      ret_val = fread (ptr, 8, 1, fp);
	  if(ret_val < 1) printf("File Read Error8\n");
	  convert_endian((char* )ptr, 8);
      *double_val = *((double *) ptr);
      *int_val = (int)*double_val;
      *uint_val = (unsigned int)*double_val;
      break;
